...
<body>
    ...
    <div class="site-main">
        <div class="container-fluid no-padding">
            ...
            <section class="breadcrumb-section set-bg" data-setbg="imgs/BANNERS/MENU.png">
                <div class="container">
                    <div class="row">
        ...
        <section class="food_section layout_padding">
            <div class="container">
                ...
                <ul class="filters_menu">
                    ...
                    <li data-filter=".donas">Donas</li>
                    <li data-filter=".pastel">Pasteles</li>
                    <li data-filter=".cup">Cupcake</li>
                    <li data-filter=".pays">Pays</li>
                    <?php
                     if($Nombre!="Registrate"){

                        echo' <a href="Personalizado.php" class="btn btn-primary">Personalizado</a>';
                     }
                    ?>
                ...
                <div class="filters-content">
                    <div class="row grid">
                       ...
                       include_once 'phpcode/menucode.php';
                        ...
                        <script>
                            var Users = '<?=$Nombre?>';
                              ...
                              if(Users != "Registrate"){
                                ...
                                $('a[href="#agregar"]').on('click', function(){
                                    let data = {
                                        id:{
                                            0:this.dataset.id
                                        },
                                    ...
                                    $.post('./Crud/crear_elementos.php', data).done(function(){
