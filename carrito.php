            ...
            <div class="navbar">
                <ul class="navbar-nav">
                  <label style="color: #f06595;" for="menuss"><?php if(isset($_SESSION['id_user'])){ echo 'Bienvenido';}?> <span><?php echo $_SESSION['name']; ?></span></label>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="carrito.php"><i
                                class="fas fa-shopping-cart fa-lg" style="color: #f06595;">Carrito</i></a></li>
                                        ...
                                        foreach( $_SESSION['carrito'] as $id => $cantidad ){
                                            ...
                                            */
                                            ...
                                            if( $arrayList = $statement->fetchAll() ){
                                                ...
                                                ?><tr data-productid="<?=$producto['idProduct']?>">
                                                <td class="shoping__cart__item">
                                                    <img src="<?=$producto['Imagen']?>" style="max-width: 175px;">
                                                ...
                                                $sumatoria+= ($producto['Precio']*$cantidad);
                                            }
                                        } ?>
                                            <script>
                                            window.addEventListener('load', function() {
                                                $('tr[data-productid]').each(function(i, tr) {
                                                    $dec = $(tr).find('.pro-qty .dec');
                                                    $inc = $(tr).find('.pro-qty .inc');
                                                    $dec.click(function() {
                                                        if (_conteo = parseInt($(this).next(
                                                                'input').val())) {
                                                            ...
                                                            $.post({
                                                                url: './Crud/actualizar_elementos.php',
                                                                data: formData
                                                            }).done(function() {
                                                                if (!formData
                                                                    .cantidad) {
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="shoping__cart__btns">
                                    <a href="menu.php" class="primary-btn cart-btn">Continuar comprando</a>
                                    <a href="carrito.php" class="primary-btn cart-btn cart-btn-right"><span
                            ...
                            <div class="col-lg-12">
                                <div class="shoping__checkout">
                                    ...
                                    <ul>
                                        ...
                                        <li>Subtotal <span>$<?=($sumatoria??0)?></span></li>
                                        <li>Total <span>$<?=($sumatoria??0)?></span></li>
                                    </ul>
                                    <a href="Detallesp.php" class="primary-btn">VALIDACION DE PEDIDO</a>
                                </div>
                            </div>
                        </div>
                    </div>
