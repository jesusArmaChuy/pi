            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Pedidos.php">Pedidos menu</a>
                    ...
                    <h2 class="widget-header">PEDIDOS POR MENU</h3>
                        <table id='myTable' class="table table-responsive product-dashboard-table">
                            ...
                            <tbody>
                                ...
                                try {
                                    $sql  = "SELECT  * FROM vw_pedidosdeusuario";
                              ...
                              <td class="action" data-title="Action">
                                  ...
                                  <form method="POST">
                                      <ul class="list-inline justify-content-center">
                                          ...
                                          <li class="list-inline-item">
                                                <button name="accion" type="submit" value="Delete_User" data-toggle="tooltip" data-placement="top" title="Cancelar pedido"
